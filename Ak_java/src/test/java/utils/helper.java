...
public class helper {
	...
	//	System.setProperty("webdriver.chrome.driver", "D:\\EAI\\workspace\\Ak_java\\webdriver\\chromedriver.exe");
		...
		else if(browser=="edge")
		{
			...
			//System.setProperty("webdriver.edge.driver", "D:\\EAI\\workspace\\Ak_java\\webdriver\\msedgedriver.exe");
...
ele.sendKeys(input);
	...
	public static String screenshot(WebDriver driver) throws IOException
	{
		...
		String des="D:\\EAI\\workspace\\Ak_java\\screenshots\\"+unicvalue()+"abc.png";
